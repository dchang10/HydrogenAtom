...
function Banner(){
    return(
        <div className="row" style={{height:'400px', 
                backgroundPosition:'50% 50%', backgroundSize:'40%',
                backgroundColor:'gray', backgroundImage: 'url("http://www.clker.com/cliparts/b/8/c/0/12065573891491312817IncessantBlabber_Stylized_atom.svg")',
                backgroundRepeat:'no-repeat', opacity:'0.8'}}>
            <div className="col-lg-3">
            </div>
            <div className="col-lg-6" style={{paddingTop: '150px'}}>
                <h1 className="blend-title box-title" align="center"> The Hydrogen Atom</h1>
            </div>
            <div className="col-lg-3">
            </div>
        </div>
        ...
        <Fragment>
            ...
            <div className="row">
                <div className="col-lg-12">
                    <h2 align="center" style={{fontWeight:'bold', color:0xAC2B37}}>
                        The Bohr Model
                    </h2>
                </div>
            </div>
